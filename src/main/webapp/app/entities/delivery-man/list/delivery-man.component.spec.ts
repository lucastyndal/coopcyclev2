...
describe('DeliveryMan Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'delivery-man', component: DeliveryManComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to deliveryManService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDeliveryManIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDeliveryManIdentifier).toHaveBeenCalledWith(entity);
