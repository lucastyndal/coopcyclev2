...
describe('DeliveryMan routing resolve service', () => {
  ...
  let resultDeliveryMan: IDeliveryMan | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDeliveryMan).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDeliveryMan>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
