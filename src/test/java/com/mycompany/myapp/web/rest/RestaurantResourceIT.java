...
class RestaurantResourceIT {
    ...
    public static Restaurant createEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(DEFAULT_NAME).address(DEFAULT_ADDRESS).rating(DEFAULT_RATING);
        return restaurant;
    }
    ...
    public static Restaurant createUpdatedEntity(EntityManager em) {
        Restaurant restaurant = new Restaurant().name(UPDATED_NAME).address(UPDATED_ADDRESS).rating(UPDATED_RATING);
        return restaurant;
    }
    ...
    void getAllRestaurantsWithEagerRelationshipsIsNotEnabled() throws Exception {
        ...
        restRestaurantMockMvc.perform(get(ENTITY_API_URL + "?eagerload=false")).andExpect(status().isOk());
        verify(restaurantRepositoryMock, times(1)).findAll(any(Pageable.class));
    }
    ...
    void putExistingRestaurant() throws Exception {
        ...
        updatedRestaurant.name(UPDATED_NAME).address(UPDATED_ADDRESS).rating(UPDATED_RATING);
    ...
    void fullUpdateRestaurantWithPatch() throws Exception {
        ...
        partialUpdatedRestaurant.name(UPDATED_NAME).address(UPDATED_ADDRESS).rating(UPDATED_RATING);
